...
export default class AccessController {
  ...
  // static userSignUpWithGoogle = asyncHandler(async (req, res) => {
  //   try {
  //     if (!req.user) {
  //       res.status(400);
  //       throw new Error("Failed to get user details");
  ...
  //         AuthController.generateResponse(
  //           201,
  //           "User has been successfully sign up with google",
  //           {
  //             id: user._id,
  //             first_name: user.first_name,
  //             last_name: user.last_name,
  ...
  //       res.status(400)
  //       throw new Error("User with this email id already registered")
  //     }
  //   } catch (error) {
  //     throw new Error(error);
  //   }
